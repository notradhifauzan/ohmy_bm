...
/** remove this on new project */
function isAdmin()
{
    if (isset($_SESSION['current_controller']) && $_SESSION['current_controller'] == 'admins') {
        return true;
    } else if (isset($_SESSION['current_controller']) && $_SESSION['current_controller'] == 'students') {
        return false;
    }
}
