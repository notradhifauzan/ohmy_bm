...
<head>
    ...
    <?php require APPROOT . '/views/student/css/style_register.php'; ?>
            ...
            <form action="<?php echo URLROOT ?>/students/register" method="POST">
                <div class="formcontainer">
                    ...
                    <div class="input">
                        ...
                        <input value="<?php echo $data['email'] ?>" type="text" placeholder="Masukkan email" name="email" required>
                    </div>
                    ...
                    <div class="input">
                        ...
                        <input value="<?php echo $data['confirm_password'] ?>" type="password" placeholder="Sahkan kata kunci" name="confirm_password" required>
                    </div>
